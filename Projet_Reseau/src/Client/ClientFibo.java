...
/**
 * Classe représentant un client envoyant un nombre a un serveur et recuperant la valeur de la suite de Fibonacci de celui ci
 * @author max
 *
 */
public class ClientFibo extends Thread{
	...
	/**
	 * Nombre dont on souhaite connaitre la valeur de Fibonacci
	 */
	 ...
	 * @param param Nombre dont on souhaite connaitre la valeur de Fibonacci
	 ...
	 */
	public ClientFibo(String param,int port, String adresse) throws IOException{
		super();
		this.port = port;
		this.param = param;
